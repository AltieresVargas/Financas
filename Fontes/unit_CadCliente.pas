         ...
         begin
            ...
            btn_LimparClick(Sender);
             ...
             begin
                ...
                'Não foi possível '+ InsertOuUpdate + ' o Cliente, possíveis causas: ' +
                Erro ,
    ...
    if (edt_ConsCPF.Text = '') and (edt_NomeCliente.Text = '') then
      ...
      begin
         ...
         if (db_Clientes.DataSet.FieldByName('id_cliente').AsInteger <= 0) and
              ...
              begin
                frc_criar_msg('Atenção!!!',
                    'Cliente não encontrado!!',
                    'Informações de pesquisa não encontradas entre os clientes cadastrados na base de dados!!',
